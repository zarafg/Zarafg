...
<head>
    ...
    <style>
        /* Aqui cambio los estilos de las diferentes secciones de la página*/
        body {
            padding-top: 50px;
        ...
        /* Se pueden agregar los que quieras estando bien identificados */
    </style>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container">
            <a class="navbar-brand" href="#">Portal de Videojuegos</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="#seccion-juegos">Juegos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="#seccion-formulario">Formulario</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="#secction-home">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="#secction-contacto">Contacto</a>
                    </li>
        ...
        <div class="container mt-5">
            ...
            <div id="miCarrusel" class="carousel" data-bs-ride="carousel">
                ...
                <div class="carousel-item active">
                    <img src="rust.jpg" class="d-block w-100" alt="Primera imagen">
                </div>
    ...
    <div class="container" id="seccion-juegos">
        ...
        <div class="row">
            <div class="col-md-4">
             ...
             <div class="col-md-4">
                <div class="card">
                    <img src="tarkov.jpg" class="card-img-top" alt="Juego 1">
                    <div class="card-body">
